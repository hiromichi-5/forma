...
type MemberRepository interface {
	Upsert(ctx context.Context, userID uuid.UUID, formID uuid.UUID, role entity.Role) error
	Delete(ctx context.Context, userID uuid.UUID, formID uuid.UUID) error
	GetRole(ctx context.Context, userID uuid.UUID, formID uuid.UUID) (entity.Role, error)
